    ...
    <div id="projects" className="section">
      ...
      <section className="project">
        ...
        <div className="buttons">
          <button className="button"><a target="_blank" href='https://github.com/Elsa245/project-4-server'><FaGithubSquare /> View on GitHub</a></button>
          {/* <button className="button ml-5"><a target="_blank" href=''><BiLinkAlt /> View project</a></button> */}
        </div>
      </section>

      <section className="project">
        <a target="_blank" href="https://trippy-project.netlify.app/"><h2>Trippy</h2>
        </a>
        <div className="project-devicons">
        <div className="project-devicon">
        ...
        <div className="buttons">
          <button className="button"><a target="_blank" href='https://github.com/Elsa245/project-3-server'><FaGithubSquare /> View on GitHub</a></button>
          <button className="button ml-5"><a target="_blank" href='https://trippy-project.netlify.app/'><BiLinkAlt /> View project</a></button>
        </div>
      </section>

      <section className="project">
        <a target="_blank" href="https://art-match.netlify.app/"><h2>ArtMatch</h2></a>
        <div className="project-devicons">
          <div className="project-devicon">
            <i className="devicon-javascript-plain"></i>
          </div>
        ...
        <div className="buttons">
          <button className="button"><a target="_blank" href='https://github.com/Elsa245/sei-project-2'><FaGithubSquare /> View on GitHub</a></button>
          <button className="button ml-5"><a target="_blank" href='https://art-match.netlify.app/'><BiLinkAlt /> View project</a></button>
        </div>
      </section>

      <section className="project">
        <a target="_blank" href="https://elsa245.github.io/project-1/"><h2>Space Invaders</h2></a>
        <div className="project-devicons">
          <div className="project-devicon">
            <i className="devicon-javascript-plain"></i>
          </div>
        ...
        <div className="buttons">
          <button className="button"><a target="_blank" href='https://github.com/Elsa245/project-1'><FaGithubSquare /> View on GitHub</a></button>
          <button className="button ml-5"><a target="_blank" href='https://elsa245.github.io/project-1/'><BiLinkAlt /> View project</a></button>
        </div>
      </section>
    {/* <hr /> */}
    </div>
